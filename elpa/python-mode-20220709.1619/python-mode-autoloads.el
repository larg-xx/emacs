...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "python-mode" '("pdb-track-stack-from-shell-p" "pep8" "pst-here" "autopair-mode" "all-mode-setting" "virtualenv-" "info-lookup-mode" "ipython" "isympy3" "iypthon" "force-py-shell-name-p-o" "flake8" "toggle-force-py-shell-name-p" "turn-o" "jython" "stri" "highlight-indent-active" "hs-hide-comments-when-hiding-all")))
